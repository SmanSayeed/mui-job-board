...
export default function JobListingFilters({
  ...
  return (
    <Box sx={{ display: 'flex', gap: 1.5 }}>
      <Select size="small" value={jobStatus} onChange={e => onJobStatusChange(e.target.value)} sx={{ minWidth: 120 }}>
        <MenuItem value="all">Job Status</MenuItem>
        <MenuItem value="active">Active</MenuItem>
        <MenuItem value="closed">Closed</MenuItem>
      </Select>
      <Select size="small" value={jobType} onChange={e => onJobTypeChange(e.target.value)} sx={{ minWidth: 120 }}>
      ...
      <Select size="small" value={datePosted} onChange={e => onDatePostedChange(e.target.value)} sx={{ minWidth: 120 }}>
        <MenuItem value="all">Date Posted</MenuItem>
        <MenuItem value="today">Today</MenuItem>
        <MenuItem value="week">This Week</MenuItem>
        <MenuItem value="month">This Month</MenuItem>
      </Select>
      <Select size="small" value={applicants} onChange={e => onApplicantsChange(e.target.value)} sx={{ minWidth: 120 }}>
